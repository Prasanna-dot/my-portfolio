  ...
  return (
    <section className='div_backgrounds h-auto w-full'>
      ...
      <div className="h-auto px-[10%] pb-[7%] my-font2 text-center text-[2vw]">
        <p className="py-5 sm:font-xl">It all began back in 2016 when I enrolled in a diploma program for Electrical and Electronics Engineering at Sastra University in Thanjavur. The initial year flew by, and as I stepped into the second year, an advice from one of our staff members changed my course.</p>
